...
class RGB_SClusterFormer(nn.Module):
    def __init__(self, img_size=224, in_chans=3, num_classes=1000, num_stages=3,
        ...
        #    This reduces offset channels from 162 to 18, saving massive amounts of memory.
        # ---
        ...
        # ---
        # *** FIX ***
        # 2. The MultiScaleDeformConv2D wrapper was removed from the stem.
        #    We now just use the single deform_conv_stem. This stops the
        #    input from being upscaled, which was the other cause of the OOM.
        # ---
